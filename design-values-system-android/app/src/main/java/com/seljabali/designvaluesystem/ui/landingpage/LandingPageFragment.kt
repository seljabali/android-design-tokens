...
import com.seljabali.designvaluesystem.ui.VerticalSpacingsFragment
...
class LandingPageFragment : BaseFragment() {
    ...
    private fun onPageItemClicked(landingPageItem: LandingItem) {
        ...
        when (landingPageItem) {
            LandingPageItems.TEST -> homeActivity.showFragment(VerticalSpacingsFragment.newInstance(), VerticalSpacingsFragment.TAG)
        }
        return
    }
